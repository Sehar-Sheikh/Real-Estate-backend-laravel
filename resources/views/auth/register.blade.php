    ...
    <nav class="bg-white shadow-md" id="home">
        ...
        <div id="mobile-menu" class="md:hidden bg-white p-4 hidden">
            <div class="flex flex-col space-y-2">
                <a href="../index.html#home"
                    class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">Home</a>
                <a href="#" class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">Properties</a>
                <a href="../index.html#services"
                    class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">Services</a>
                <a href="../index.html#about"
                    class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">About</a>
                <a href="../index.html#contact"
                    class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">Contact</a>
...
">
        ...
        {{-- <form action="/register" method="POST"> --}}
            ...
            <input type="text" id="name" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="e.g. John Doe">
            <x-input-error :messages="$errors->get('name')" class="mt-2" />

            <label for="email" :value="__('Email')">Email</label>
            <input type="email" id="email" name="email" :value="old('email')" required autocomplete="username" placeholder="abc@example.com">
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
    ...
    <footer class="bg-teal-600 text-white py-8 footer">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mt-12">
                <p>
                    &copy; 2024 Dream Home Real Estate. All rights
                    reserved.
                </p>
            </div>
        </div>
