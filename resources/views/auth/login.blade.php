...
<body style="min-height: 100vh; background: linear-gradient(to bottom, #f0fdfa, #c6f6d5); color: #1a202c;">
    ...
    <nav class="bg-white shadow-md" id="home">
        ...
        <div id="mobile-menu" class="md:hidden bg-white p-4 hidden">
            <div class="flex flex-col space-y-2">
                <a href="../index.html#home" class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">Home</a>
                <a href="#" class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">Properties</a>
                <a href="../index.html#services" class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">Services</a>
                <a href="../index.html#about" class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">About</a>
                <a href="../index.html#contact" class="text-teal-700 hover:text-teal-500 transition-colors hover-pop">Contact</a>
    ...
    <x-auth-session-status class="mb-4" :status="session('status')" />
        ...
        {{-- <form action="/login" method="POST" style="width: 100%;"> --}}
            ...
            <input type="email" id="email" name="email" placeholder="abc@example.com" :value="old('email')" required autofocus autocomplete="username"
                style="
                width: 100%;
                padding: 8px;
